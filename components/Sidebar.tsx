...
import { 
  Home, Map, Briefcase, ShieldCheck, 
  MapPin, Leaf, MessageSquare, Award, User as UserIcon
} from 'lucide-react';
        ...
        {userProfile && (
          <div className="flex items-center gap-3 mb-4 p-2 rounded-xl bg-stone-50 dark:bg-stone-800">
            ...
            <div className="flex-1 min-w-0">
              <p className="text-sm font-medium text-stone-900 dark:text-stone-100 truncate">{userProfile.name}</p>
              <p className="text-xs text-stone-500 dark:text-stone-400">Level: {userProfile.ecoScore} Pt</p>
            </div>
          </div>
        )}
