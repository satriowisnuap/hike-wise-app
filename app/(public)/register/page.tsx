      ...
      <div className="max-w-md w-full bg-white dark:bg-stone-900 md:rounded-2xl md:shadow-lg md:border border-stone-200 dark:border-stone-700 p-8">
        <div className="text-center mb-8">
          <Link href="/" className="inline-flex items-center gap-2 mb-6">
            ...
            <span className="text-2xl font-bold text-emerald-600 dark:text-emerald-400">Hike Wise</span>
          </Link>
          <h2 className="text-2xl font-bold text-stone-900 dark:text-stone-100">Daftar Akun Baru</h2>
          <p className="mt-2 text-sm text-stone-500 dark:text-stone-400">Mulai petualangan cerdasmu bersama kami</p>
        </div>

        <form onSubmit={handleRegister} className="space-y-5">
          <div>
            <label className="block text-sm font-medium text-stone-900 dark:text-stone-100 mb-1">Nama Lengkap</label>
            <input
              type="text"
              required
              value={name}
          ...
          <div>
            <label className="block text-sm font-medium text-stone-900 dark:text-stone-100 mb-1">Kata Sandi</label>
            <input
              type="password"
              required
              minLength={8}
          ...
          <div>
            <label className="block text-sm font-medium text-stone-900 dark:text-stone-100 mb-1">Konfirmasi Kata Sandi</label>
            <input
              type="password"
              required
              minLength={8}
