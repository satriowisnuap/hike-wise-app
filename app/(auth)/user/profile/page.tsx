...
export default function ProfilePage() {
  ...
  const dateStr = userProfile.createdAt 
    ? new Date(userProfile.createdAt.toMillis()).toLocaleDateString('id-ID', { year: 'numeric', month: 'long', day: 'numeric' })
    : 'Tidak diketahui';
    ...
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <div className="bg-white dark:bg-stone-900 border border-stone-200 dark:border-stone-700 p-4 rounded-2xl flex flex-col items-center justify-center text-center relative overflow-hidden">
          ...
          <p className="text-2xl font-bold text-stone-900 dark:text-stone-100 relative z-10">{userProfile.ecoScore}</p>
      ...
      <div className="bg-emerald-50 dark:bg-emerald-950 border border-emerald-100 dark:border-emerald-900 p-6 rounded-2xl">
        <div className="flex justify-between items-end mb-2">
          <div>
            ...
            <p className="text-xs text-emerald-600 dark:text-emerald-400/70">{nextLevelScore - userProfile.ecoScore} Pt menuju level selanjutnya</p>
          </div>
