...
export default function AdminMountainsPage() {
    ...
    const filtered = mountains.filter((m) => {
        ...
        const statusMatch =
            filterStatus === 'all' || (filterStatus === 'open' && m.isOpen) || (filterStatus === 'closed' && !m.isOpen);
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div>
                    ...
                    <p className="text-sm text-stone-500 dark:text-stone-400">
                        Manajemen direktori gunung untuk aplikasi.
                    </p>
                </div>
                <button
            ...
            <div className="bg-white dark:bg-stone-900 p-4 rounded-2xl border border-stone-200 dark:border-stone-700 flex flex-col md:flex-row gap-4">
                ...
                <div className="flex gap-2">
                    <Select
                        ...
                        onChange={(val) => {
                            setFilterDifficulty(val as string);
                            setPage(1);
                        }}
                        options={[
                            { label: 'Semua Kesulitan', value: 'all' },
                                ...
                                <td className="p-4 text-center">
                                    <label className="relative inline-flex items-center cursor-pointer">
                                        <input
                                            ...
                                            checked={m.isOpen}
                                            onChange={() => handleToggleStatus(m.id, m.isOpen)}
                                        />
                    ...
                    <div className="fixed inset-y-0 right-0 z-50 w-full md:w-[420px] bg-white dark:bg-stone-900 shadow-2xl border-l border-stone-200 dark:border-stone-700 flex flex-col animate-in slide-in-from-right duration-300">
                        <div className="p-6 border-b border-stone-200 dark:border-stone-700 flex items-center justify-between shrink-0 bg-stone-50 dark:bg-stone-900/50">
                            <h2 className="text-xl font-bold text-stone-900 dark:text-stone-100">
                                {isEditing ? 'Edit Gunung' : 'Tambah Gunung'}
                            </h2>
                            <button
                                onClick={() => !saving && setIsPanelOpen(false)}
                            ...
                            <form id="mountain-form" onSubmit={handleSave} className="space-y-5">
                                ...
                                <div className="space-y-2">
                                    <Select
                                        ...
                                        onChange={(val) => setFormData({ ...formData, province: val as string })}
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    ...
                                    <div className="space-y-2">
                                        <Select
                                            ...
                                            onChange={(val) =>
                                                setFormData({ ...formData, difficulty: val as Mountain['difficulty'] })
                                            }
                                            options={[
                                                { label: 'Mudah', value: 'easy' },
                                                { label: 'Sedang', value: 'medium' },
                                ...
                                <div className="space-y-2">
                                    ...
                                    />
                                    <div
                                        className={`text-right text-xs ${descLen < 100 ? 'text-amber-500' : 'text-emerald-500'}`}
                                    >
                                ...
                                <div className="flex items-center justify-between py-2">
                                    <div>
                                        ...
                                        <p className="text-xs text-stone-400 mt-0.5">
                                            {formData.isOpen ? 'Dibuka untuk pendaki' : 'Ditutup sementara'}
                                        </p>
                                    </div>
                                    <label className="relative inline-flex items-center cursor-pointer">
                                        <input
                ...
                <div className="fixed inset-0 bg-black/50 z-[60] flex items-center justify-center p-4 backdrop-blur-sm animate-in fade-in">
                    <div className="bg-white dark:bg-stone-900 rounded-2xl max-w-sm w-full p-6 shadow-2xl animate-in zoom-in-95">
                        ...
                        <p className="text-stone-500 dark:text-stone-400 text-sm mb-6">
                            Tindakan ini tidak dapat dibatalkan. Data gunung akan dihapus permanen dari database.
                        </p>
